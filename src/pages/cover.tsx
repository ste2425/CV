      ...
      <Container>
            ...
            <Row>
                <Col xs={12} md={8} className="blue text-white d-flex justify-content-center align-items-center">
                    <p className="generated-message d-none">This document was auto generated from my live Cover Letter <a className="w-100" href="https://ste2425.github.io"><u>here</u></a></p>
                </Col>
            ...
            <Row>
                <Col xs={12} md={8} className="bg-white">
                  <p className="pt-4 ps-2">I was lucky enough to begin my career during the build up to ES6 (now ES2015). This was a great time of excitement within the industry and any mention of JavaScript was followed by demonstrations of brilliant sounding new features, especially to a junior. I went to many conferences where engineers were demoing these brilliant new features, I remember one vividly where on one day JavaScript was powering a micro controller (this was before I knew what an Arduino was) and the second day I got my first demonstration of Angular.JS. It seemed like nothing was impossible with the technology and that excitement and desire to see more has stuck with me ever since.</p>
                  
                  <p className="pt-4 ps-2">Since then I have over 10 years of experience working with JavaScript and TypeScript and have used some fantastic frameworks including NestJS, React and Angular. My experience is not limited to JavaScript based services but also C# and .net core.</p>

                  <p className="pt-4 ps-2">I have extensive experience building scalable applications utilising a number of architectures including event driven architecture, monoliths and micro services. I have worked in teams with my peers where we all collaborated together working towards the same goal. I have also lead a team of juniors building and managing greenfield projects whilst upskilling them to skilled mid level engineers by the time I left.</p>

                  <p className="pt-4 ps-2">Software engineering is not just a career but a hobby, I have many personal projects which can be viewed on my GitHub, most recently adding Bluetooth controller support to my Sony PSP. I use my personal projects as opportunities to learn technologies my work does not allow me to use.</p>
                </Col>
